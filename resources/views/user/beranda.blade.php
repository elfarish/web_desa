...
@section('content')
    ...
    <section class="hero-section position-relative text-white">
        ...
        <!-- Caption tetap diam -->
        <div class="carousel-caption d-flex flex-column justify-content-center text-center position-absolute top-0 start-0 w-100 h-100">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-4 mb-4 text-center" data-aos="zoom-in">
                    <img src="{{ asset('images/sambutan.png') }}" alt="Kepala Desa" class="img-fluid rounded shadow mb-3">
                ...
                <div class="col-md-8" data-aos="fade-left">
                    <p class="fs-5">
                        ...
                        terbaik, membangun desa dengan partisipatif, serta menjaga transparansi dalam tata kelola pemerintahan desa.
                    </p>
                    <p class="fs-5">
            ...
            <div class="row g-4 justify-content-center">
                @foreach ($stats as $index => $stat)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="{{ $index * 100 }}">
                        <div class="stat-card bg-white rounded shadow-sm p-4 h-100 d-flex flex-column align-items-center justify-content-center text-center">
