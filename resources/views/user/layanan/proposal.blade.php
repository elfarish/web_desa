        ...
        <div class="container">
            ...
            <div class="row g-4">
                @php
                    ...
                    $proposalFormLink = Setting::get('proposal_form', '#');
                    ...
                    $steps = [
                        ...
                        [
                            ...
                            'desc' => 'Klik tombol "Ajukan Proposal" untuk mengunggah proposal melalui Google Form.',
                            'icon' => 'fas fa-file-upload',
                            'btn' => $proposalFormLink,
                            ...
                            <div class="card-body d-flex flex-column">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <h5 class="card-title mb-0"><i
                                            class="{{ $step['icon'] }} me-2 text-primary"></i>{{ $step['title'] }}</h5>
                                </div>
