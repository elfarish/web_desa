...
@section('content')
    ...
    <section class="position-relative text-center"
        style="background-image: url('{{ asset('storage/images/kantor_desa.png') }}'); background-size: cover; background-position: center; height: 300px;">
        ...
        <div class="position-relative text-white d-flex flex-column justify-content-center align-items-center h-100"
            ...
            <h1 class="fw-bold display-5 text-shadow">Struktur Kepengurusan Desa</h1>
            <p class="lead text-warning fw-semibold">Struktur kepengurusan Desa Pabuaran</p>
        </div>
    </section>
    ...
    <div class="container my-5">
            ...
            <div class="row justify-content-center mb-4">
                <div class="col-md-3 col-sm-6 col-12 person-card text-center">
                    <img src="{{ $kepengurusan['kepalaDesa']->foto
                        ...
                        : asset('storage/struktural/default image.png') }}"
        ...
        <div class="row justify-content-center mb-4">
            @foreach ($kepengurusan['kasiKaur'] as $staf)
                <div class="col-md-2 col-sm-6 col-12 person-card text-center">
                    <img src="{{ $staf->foto ? asset('storage/' . $staf->foto) : asset('storage/struktural/default image.png') }}"
        ...
        <div class="row justify-content-center mb-4">
            @foreach ($kepengurusan['kadus'] as $dusun)
                <div class="col-md-2 col-sm-6 col-12 person-card text-center">
                    <img src="{{ $dusun->foto ? asset('storage/' . $dusun->foto) : asset('storage/struktural/default image.png') }}"
        ...
        <div class="row justify-content-center">
            @foreach ($kepengurusan['staf'] as $pembantu)
                <div class="col-md-2 col-sm-6 col-12 person-card text-center">
                    <img src="{{ $pembantu->foto ? asset('storage/' . $pembantu->foto) : asset('storage/struktural/default image.png') }}"
