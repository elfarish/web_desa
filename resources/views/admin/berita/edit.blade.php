                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kategori" class="form-control" required>
                                            ...
                                            <option value="Infrastruktur"
                                                {{ old('kategori', $berita->kategori) == 'Infrastruktur' ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="ringkasan" class="form-control" rows="3" placeholder="Ringkasan Berita..." required>{{ old('ringkasan', $berita->ringkasan) }}</textarea>
                                @error('ringkasan')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="isi" class="form-control" rows="5" placeholder="Isi Berita..." required>{{ old('isi', $berita->isi) }}</textarea>
                                @error('isi')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control" required>
                                    ...
                                    <option value="pending"
                                        {{ old('status', $berita->status) == 'pending' ? 'selected' : '' }}>Pending
                                    </option>
                                </select>
                                @error('status')
                                    <span class="text-danger">{{ $message }}</span>
